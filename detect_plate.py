...
# Ensure repo root or PyInstaller temp folder is on sys.path so torch.load can import
# pickled modules like `models.yolo` when running as a frozen executable.
...
# Import models.yolo explicitly so the unpickler can find it inside the bundle.
try:
    import models.yolo  # noqa: F401
except Exception:
    # If import fails, it will surface later when loading the model; keep going now.
    pass
